! Exact RS Euler equations using Newton's method with Average pressure initial guess
! =========================================================
...
! =========================================================
    ...
    if (conv_criteria==1) then
        ...
        print *,"Iterations Newton HLLE: ", iterations/(n_data +0.d0)
        ...
        call cpu_time(finish_time)
        exec_time=finish_time-start_time
        print *,"Iterations Newton HLLE stagnation criteria: ", iterations/(n_data +0.d0)
...
double precision function pStarNonVacuum(gamma,pL,uL,rhoL,pR,uR,rhoR,aL,aR,tol,iterations) 
    ...
    if (0<=phiMin) then
        ...
        p=gamma1*(Em-0.5d0*u_rhom**2/rhom)
