! Exact RS Euler equations using Newton's method with Two Rarefaction initial guess
! =========================================================
...
! =========================================================
    ...
    if (conv_criteria==1) then
        ...
        print *,"Iterations Newton TR: ", iterations/(n_data +0.d0)
        ...
        call cpu_time(finish_time)
        exec_time=finish_time-start_time
        print *,"Iterations Newton TR stagnation criteria: ", iterations/(n_data +0.d0)
